...
**Live on Bitcoin:** Deploy UNQ via [unq_deploy_mainnet.json](spec/examples/unq_deploy_mainnet.json); build yours with [exampletoken_deploy.json](spec/examples/exampletoken_deploy.json).
